<template>
  <div class="relative">
    <img :src="require('@/assets/house5.png')" class="max-md:w-[670px] max-sm:w-[570px]" alt />
    <div
      class="absolute bg-white top-[95%] left-1/2 -translate-x-1/2 -translate-y-1/2 w-[612px] max-sm:w-[400px] shadow shadow-[0px 9px 32px 0px #595CDB0D] flex flex-col gap-6 rounded-[10px] p-8"
    >
      <h4
        class="text-textColorPrimary font-semibold text-[20px]"
      >Best! I got the house I wanted through Hounter</h4>
      <p
        class="text-textColorQuaternary text-smallText leading-[24px] opacity-75"
      >Through this website I can get a house with the type and specifications I want very easily, without a complicated process to be able to find information on the house we want.</p>
      <div class="flex items-center justify-between">
        <div class="flex items-center gap-4">
          <img
            :src="require('@/assets/photo-1500648767791-00dcc994a43e.avif')"
            width="40"
            class="rounded-full object-cover h-[40px]"
            alt
          />
          <div class="flex flex-col">
            <span class="text-textColorPrimary text-smallText">Dianne Russell</span>
            <span class="text-textColorQuaternary text-smallText">Manager Director</span>
          </div>
        </div>
        <div class="flex items-center gap-4">
          <svg
          ...
          <span class="text-[20px] text-textColorPrimary font-semibold">4.6</span>
        </div>
      </div>
    </div>
  </div>
